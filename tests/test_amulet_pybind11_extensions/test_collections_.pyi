...
def test_items_view_cls(
    arg0: collections.abc.ItemsView[int, TestToken],
) -> collections.abc.ItemsView[int, TestToken]: ...
def test_items_view_int(
    arg0: collections.abc.ItemsView[int, int],
) -> collections.abc.ItemsView[int, int]: ...
def test_items_view_obj(
    arg0: collections.abc.ItemsView[int, typing.Any],
...
def test_iterable_int(
    arg0: collections.abc.Iterable[int], arg1: list
...
def test_iterator_int(
    arg0: collections.abc.Iterator[int], arg1: list
...
def test_keys_view_int(
    arg0: collections.abc.KeysView[int],
...
def test_map_cls(
    arg0: collections.abc.Mapping[int, TestToken],
) -> collections.abc.Mapping[int, TestToken]: ...
def test_map_int(
    arg0: collections.abc.Mapping[int, int],
) -> collections.abc.Mapping[int, int]: ...
def test_map_obj(
    arg0: collections.abc.Mapping[int, typing.Any],
) -> collections.abc.Mapping[int, typing.Any]: ...
def test_mutable_map_cls(
    arg0: collections.abc.MutableMapping[int, TestToken],
) -> collections.abc.MutableMapping[int, TestToken]: ...
def test_mutable_map_int(
    arg0: collections.abc.MutableMapping[int, int],
) -> collections.abc.MutableMapping[int, int]: ...
def test_mutable_map_obj(
    arg0: collections.abc.MutableMapping[int, typing.Any],
...
def test_sequence_int(
    arg0: collections.abc.Sequence[int], arg1: list
...
def test_values_view_int(
    arg0: collections.abc.ValuesView[int],
